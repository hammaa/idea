...
| 3쿠션 당구 포지션 해법기 (3-Cushion Position Solver) | [billiards-3cushion-solver/](billiards-3cushion-solver/) | ⚠️ 아이디어 등록 (경쟁 2건 확인) | 포지션 → 해법 선 + 다이아몬드 시스템 계산 보조. **동일 서비스가 이미 2개**(3ball 무료 / Bricole 유료·트랙션 없음). 원안 7개 중 미점유는 **팁 단위 감도표**뿐 — '해답기'가 아닌 **시스템↔물리 괴리 진단기**로 재정의 |
...
| billiards-3cushion-solver | 6 | 2026-08-30 |
